...
alert tcp $EXTERNAL_NET $HTTP_PORTS -> $HOME_NET any (msg:"WEB-CLIENT OpenOffice Word document table parsing multiple heap based buffer overflow attempt"; flowbits:isset,file.doc; flow:to_client,established; content:"|00 00 00 FF 00 00 00 FF 00 00 00 FF 00 00 00 FF 22 56|"; metadata:policy security-ips drop, service http; reference:cve,2009-0200; reference:cve,2009-0201; reference:bugtraq,36200; classtype:attempted-user; sid:17665; rev:1;)
*/
/*
...
{
    (uint8_t *) "|00 00 00 FF 00 00 00 FF 00 00 00 FF 00 00 00 FF 22|V", /* pattern (now in snort content format) */
    0, /* depth */
    0, /* offset */
...
static RuleMetaData rule17665policy3 =
{
...
Rule rule17665 = {
   ...
   { 
       ...
       "FILE-OFFICE OpenOffice Word document table parsing multiple heap based buffer overflow attempt",     /* message */
...
int rule17665eval(void *p) {
    ...
    uint8_t itcFirst;    // index of first cell to delete
    uint8_t itcLim;      // index of last cell to delete
